...
//    private static String database = "flux";//数据库
//    private static final String measurement = "data_detector";//表名
//
...
//        InfluxDBUtil.openurl = openurl;
//        InfluxDBUtil.database = database;
//    }
//
